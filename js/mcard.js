...
$().ready(function (e) {
    ...
    if ($("#Objects").text() != "") {
        ...
        objects.forEach(function (elem) {
            ...
            if (elem.type == 'img') {
                var div = "<div id='" + elem.id + "'  class='item' style='top: " + y + "px; left: " + x + "px;  position:absolute;'><img class='img' src='" + elem.resource_url + "' width='" + w + "px' height='" + h + "px'  /></div>";
                $('#' + elem.pid).append(div);
            }
                ...
                if ($("#Delegate_Image_URL").val() != "") {
                    ...
                    $(".item.photo img").attr("src", $("#Delegate_Image_URL").val()).css("width", "100%");
                }
            } else {
    ...
    if (outlineType == "OTC01") {
        ...
        strMapMedia = '<img src="' + outlineImage + '" class="mapImg" id="PreviewMap" style="border: 1px solid #ccc;" onerror="this.style.display=\'none\';">';
    }
